                  ...
                  <div className="d-flex flex-column h-100">
                    ...
                    <div className="auth-content my-auto">
                      ...
                      <div className="user-thumb text-center mb-4 mt-4 pt-2">
                        <img src="assets/images/users/avatar-1.jpg" className="rounded-circle img-thumbnail avatar-lg" alt="thumbnail" />
                    ...
                    <div className="mt-4 mt-md-5 text-center">
                      <p className="mb-0">© Transaction Management System    . Crafted with <i className="mdi mdi-heart text-danger" /> by Lirojan Dev</p>
                    </div>
                  </div>
                </div>
              </div>
