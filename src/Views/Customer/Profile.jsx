...
const Profile = () => {
      ...
      <div className="card-body">
          ...
          <div className="col-sm order-2 order-sm-1">
            <div className="d-flex align-items-start mt-3 mt-sm-0">
              ...
              <div className="flex-grow-1">
                <div>
                  <h5 className="font-size-16 mb-1">Saravanan Meenatchi</h5>
                  <p className="text-muted font-size-13">Vehicle Class (A1,B,B1)</p>
                  <div className="d-flex flex-wrap align-items-start gap-2 gap-lg-3 text-muted font-size-13">
                    <div><i className="mdi mdi-circle-medium me-1 text-success align-middle" />077 123 4567</div>
                    <div><i className="mdi mdi-circle-medium me-1 text-success align-middle" />072 456 1258</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <ul className="nav nav-tabs-custom card-header-tabs border-top mt-4" id="pills-tab" role="tablist">
          <li className="nav-item">
            <a className="nav-link px-3 active" data-bs-toggle="tab" href="#overview" role="tab">Personal Detail</a>
          </li>
          <li className="nav-item">
            <a className="nav-link px-3" data-bs-toggle="tab" href="#about" role="tab">Exam</a>
          </li>
          <li className="nav-item">
            <a className="nav-link px-3" data-bs-toggle="tab" href="#post" role="tab">Trial</a>
          </li>
          <li className="nav-item">
            <a className="nav-link px-3" data-bs-toggle="tab" href="#payment" role="tab">Payment</a>
          </li>
        </ul>
      </div>
      {/* end card body */}
        ...
        <div className="card">
          ...
          <div className="card-body">
            <dl class="row mb-0">
              ...
              <dd class="col-sm-4">Saravanan Meenatchi</dd>

              <dt class="col-sm-2">NIC No :-</dt>
              <dd class="col-sm-4">9989653214V</dd>

              <dt class="col-sm-2">Address :-</dt>
              <dd class="col-sm-4">Kovil Road kurmankadu vavuniya</dd>

              <dt class="col-sm-2">Date of Birth :-</dt>
              <dd class="col-sm-4">1999-01-01</dd>

              <dt class="col-sm-2">Age :-</dt>
              <dd class="col-sm-4">26</dd>

              <dt class="col-sm-2">Phone No :-</dt>
              <dd class="col-sm-4"> 
                <dl class="row mb-0">
                  <dd class="col-sm-12">077 125 4895 </dd>
                  <dd class="col-sm-12">077 125 4895 </dd>
  ...
  <tbody>
    <tr>
      <th scope="row" className="text-center" colSpan={4}>Charges </th>
    </tr>
    <tr>
      <th scope="row">01</th>
      <td><h5 className="font-size-15 mb-1">2024-01-01</h5></td>
    ...
    <tr>
      <th scope="row" className="text-center" colSpan={4}>Payment</th>
    </tr>
    <tr>
      <th scope="row">01</th>
      <td><h5 className="font-size-15 mb-1">2024-01-01</h5></td>
    ...
    <tr>
      ...
      <td className="border-0 text-end">32550.00</td>
    </tr>
